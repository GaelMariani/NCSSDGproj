...
data_circu <- NCSSDGproj::circular_data_Insurance(data_Insurance = data_Insurance, SDG_info = SDG_info)
...
circular_plot <- NCSSDGproj::circular_plot_Insurance(data = data_circu[[1]], label_data = ,base_data = ,grid_data = ,SDG_info = )
